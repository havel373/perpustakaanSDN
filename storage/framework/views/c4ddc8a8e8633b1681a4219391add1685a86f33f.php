                ...
                <form id="form_input">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-5">
                            ...
                            <input type="date" class="form-control" id="year_release" name="year_release" placeholder="Masukkan Tahun Terbit..." value="<?php echo e($data->year_release); ?>">
                        </div>
                        <div class="col-lg-12 mb-5">
                        ...
                        <div class="col-lg-12 mb-5">
                            ...
                            <textarea class="form-control" id="description" name="description" placeholder="Masukkan Deskripsi Buku..."><?php echo e($data->description); ?></textarea>
                        </div>
                        <div class="col-lg-12 mb-5">
                            <label for="condition" class="required form-label">Banyak Buku</label>
                            <input type="tel" class="form-control" id="qty" name="qty" placeholder="Masukkan Jumlah buku..." value="<?php echo e($data->qty); ?>">
                        </div>
                        <div class="col-lg-12 mb-5">
                    ...
                    <div class="row">
                        <div class="min-w-150px mt-10 text-end">
                            <?php if(Auth::user()->role == 'admin'): ?>
                                <?php if($data->id): ?>
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','<?php echo e(route('web.book.update',$data->id)); ?>','PATCH');" class="btn btn-sm btn-primary">Ubah Buku</button>
                                <?php else: ?>
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','<?php echo e(route('web.book.store')); ?>','POST');" class="btn btn-sm btn-primary">Simpan Buku</button>
                                <?php endif; ?>
                            <?php elseif(Auth::user()->role == 'kepsek'): ?>
                                <button id="tombol_simpan" type="button" onclick="handle_patch('<?php echo e(route('web.book.accept',$data->id)); ?>');" class="btn btn-sm btn-primary">Terima / Setuju</button>
                                <button id="tombol_simpan" type="button" onclick="handle_patch('<?php echo e(route('web.book.decline',$data->id)); ?>');" class="btn btn-sm btn-info">Tolak / Tidak Setuju</button>
                            <?php endif; ?>
                        </div>
                    </div>
                </form>
...
<script>
  number_only('qty');
</script><?php /**PATH C:\laragon\www\perpustakaanSDN\resources\views/pages/book/input.blade.php ENDPATH**/ ?>